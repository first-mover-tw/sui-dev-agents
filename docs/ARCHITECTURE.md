...
- **v2.7.0** (2026-04-06)
  - Updated to SUI v1.72.2 (testnet) / v1.71.1 (mainnet), Protocol 124
...
- **v2.5.0** (2026-03-19)
  - Updated to SUI v1.72.2 (testnet), Protocol 124
...
**Architecture designed for Protocol 124, Move 2024 Edition, SUI SDK v2, dApp Kit v2, gRPC GA**
