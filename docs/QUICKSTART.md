...
→ Configures Move.toml (Protocol 124)
...
**JSON-RPC is shut off on public fullnodes** — permanent deactivation landed 2026-07-31; public endpoints return "Method not found".
