...
SUI v1.72.2 (Protocol 124, March 2026): Regex test filtering (`--filter "pattern"`), `sui move test` uses Sui gas meter, poseidon_bn254 available, gRPC data access (GA), address aliases on mainnet.
